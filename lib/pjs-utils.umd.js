...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["pjs-utils"] = {}));
   ...
   */
  function setDomStyles$1(dom,params){
    if(dom){
   ...
   * @param {*} params 参数key-value
   */
  function setDomAttrubites$1(dom,params){
    if(dom){
      for(let key of Object.keys(params)){
   ...
   */
  function canvasImgInLocal(params, onSuccess = (data) => { }) {
  ...
  exports.TwistedEggMatter = TwistedEggMatter;
  exports.canvasImgInLocal = canvasImgInLocal;
  exports.clipboardCopy = clipboardCopy;
  exports.forEachCanReturn = forEachCanReturn;
  exports.getBase64ByType = getBase64ByType;
  exports.mergeByShallow = mergeByShallow;
  exports.onLotterty = onLotterty;
  exports.pjs_random = pjs_random;
  exports.setDomAttrubites = setDomAttrubites$1;
  exports.setDomStyles = setDomStyles$1;
